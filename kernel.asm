...
801003a0:	e8 bb 02 00 00       	call   80100660 <cprintf>
  cprintf("\n");
801003a5:	c7 04 24 87 79 10 80 	movl   $0x80107987,(%esp)
...
80102e7c:	68 f4 58 11 80       	push   $0x801158f4
...
80103feb:	68 87 79 10 80       	push   $0x80107987
...
801055e0:	68 60 4d 11 80       	push   $0x80114d60
...
801055ed:	83 c4 10             	add    $0x10,%esp
  ...
  acquire(&tickslock);
  ticks0 = ticks;
801055f0:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  while(ticks - ticks0 < n){
...
80105603:	68 60 4d 11 80       	push   $0x80114d60
80105608:	68 a0 55 11 80       	push   $0x801155a0
8010560d:	e8 1e e7 ff ff       	call   80103d30 <sleep>
  ...
  ticks0 = ticks;
  while(ticks - ticks0 < n){
80105612:	a1 a0 55 11 80       	mov    0x801155a0,%eax
...
80105674:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105677:	68 60 4d 11 80       	push   $0x80114d60
8010567c:	e8 1f ec ff ff       	call   801042a0 <acquire>
  xticks = ticks;
80105681:	8b 1d a0 55 11 80    	mov    0x801155a0,%ebx
  release(&tickslock);
80105687:	c7 04 24 60 4d 11 80 	movl   $0x80114d60,(%esp)
...
801057a2:	0f 84 88 01 00 00    	je     80105930 <trap+0x1a0>
    ...
    switch(tf->trapno){
801057a8:	83 e8 0e             	sub    $0xe,%eax
801057ab:	83 f8 31             	cmp    $0x31,%eax
...
80105abf:	bb d0 78 10 80       	mov    $0x801078d0,%ebx
...
8010686d:	68 d8 78 10 80       	push   $0x801078d8
...
80106984:	68 de 78 10 80       	push   $0x801078de
...
80106991:	68 09 79 10 80       	push   $0x80107909
...
8010699e:	68 f4 78 10 80       	push   $0x801078f4
...
80106a1d:	68 1d 79 10 80       	push   $0x8010791d
...
80106acd:	68 37 79 10 80       	push   $0x80107937
...
80106ada:	68 d8 79 10 80       	push   $0x801079d8
...
80106b73:	68 55 79 10 80       	push   $0x80107955
...
80106ba3:	68 6d 79 10 80       	push   $0x8010796d
...
80106c8c:	68 89 79 10 80       	push   $0x80107989
...
80106d5f:	68 9a 79 10 80       	push   $0x8010799a
...
80106e42:	68 be 79 10 80       	push   $0x801079be
...
80106e4f:	68 a4 79 10 80       	push   $0x801079a4
...
80106f46:	68 fc 79 10 80       	push   $0x801079fc
80106f4b:	68 c0 55 11 80       	push   $0x801155c0
80106f50:	e8 4b d2 ff ff       	call   801041a0 <initlock>
  acquire(&(shm_table.lock));
80106f55:	c7 04 24 c0 55 11 80 	movl   $0x801155c0,(%esp)
80106f5c:	e8 3f d3 ff ff       	call   801042a0 <acquire>
80106f61:	b8 f4 55 11 80       	mov    $0x801155f4,%eax
...
void shminit() {
  ...
  acquire(&(shm_table.lock));
  for (i = 0; i< 64; i++) {
80106f87:	3d f4 58 11 80       	cmp    $0x801158f4,%eax
...
80106f91:	68 c0 55 11 80       	push   $0x801155c0
