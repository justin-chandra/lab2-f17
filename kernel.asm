...
80100394:	e8 b7 02 00 00       	call   80100650 <cprintf>
  cprintf("\n");
80100399:	c7 04 24 fb 77 10 80 	movl   $0x801077fb,(%esp)
...
801009cb:	0f 84 48 02 00 00    	je     80100c19 <exec+0x279>
        end_op();
        cprintf("exec: fail\n");
        return -1;
    }
...
80100b67:	0f 84 94 00 00 00    	je     80100c01 <exec+0x261>
        goto bad;
...
80100b74:	0f 84 a2 01 00 00    	je     80100d1c <exec+0x37c>
...
80100b8a:	eb 2e                	jmp    80100bba <exec+0x21a>
...
80100bac:	0f 84 82 00 00 00    	je     80100c34 <exec+0x294>
80100bb2:	83 c2 04             	add    $0x4,%edx
        if(argc >= MAXARG)
80100bb5:	83 fe 20             	cmp    $0x20,%esi
80100bb8:	74 47                	je     80100c01 <exec+0x261>
            goto bad;
        sp = (sp - (strlen(argv[argc]) + 2)) & ~3;
80100bba:	89 04 24             	mov    %eax,(%esp)
80100bbd:	89 95 e8 fe ff ff    	mov    %edx,-0x118(%ebp)
80100bc3:	e8 c8 38 00 00       	call   80104490 <strlen>
80100bc8:	b9 fe ff ff ff       	mov    $0xfffffffe,%ecx
80100bcd:	29 c1                	sub    %eax,%ecx
        if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100bcf:	8b 07                	mov    (%edi),%eax
    ...
    for(argc = 0; argv[argc]; argc++) {
        if(argc >= MAXARG)
            goto bad;
        sp = (sp - (strlen(argv[argc]) + 2)) & ~3;
80100bd1:	01 cb                	add    %ecx,%ebx
80100bd3:	83 e3 fc             	and    $0xfffffffc,%ebx
        if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100bd6:	89 04 24             	mov    %eax,(%esp)
80100bd9:	e8 b2 38 00 00       	call   80104490 <strlen>
80100bde:	83 c0 01             	add    $0x1,%eax
80100be1:	89 44 24 0c          	mov    %eax,0xc(%esp)
80100be5:	8b 07                	mov    (%edi),%eax
80100be7:	89 5c 24 04          	mov    %ebx,0x4(%esp)
80100beb:	89 44 24 08          	mov    %eax,0x8(%esp)
80100bef:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100bf5:	89 04 24             	mov    %eax,(%esp)
80100bf8:	e8 13 61 00 00       	call   80106d10 <copyout>
80100bfd:	85 c0                	test   %eax,%eax
80100bff:	79 8f                	jns    80100b90 <exec+0x1f0>
    freevm(oldpgdir);
    return 0;
...
bad:
    if(pgdir)
        freevm(pgdir);
80100c01:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100c07:	89 04 24             	mov    %eax,(%esp)
80100c0a:	e8 b1 5d 00 00       	call   801069c0 <freevm>
    if(ip){
        iunlockput(ip);
        end_op();
    }
...
80100c14:	e9 f9 fd ff ff       	jmp    80100a12 <exec+0x72>
    struct proc *curproc = myproc();
    ...
    if((ip = namei(path)) == 0){
        end_op();
80100c19:	e8 52 1f 00 00       	call   80102b70 <end_op>
        cprintf("exec: fail\n");
80100c1e:	c7 04 24 a1 6e 10 80 	movl   $0x80106ea1,(%esp)
80100c25:	e8 26 fa ff ff       	call   80100650 <cprintf>
        return -1;
80100c2a:	b8 ff ff ff ff       	mov    $0xffffffff,%eax
80100c2f:	e9 de fd ff ff       	jmp    80100a12 <exec+0x72>
80100c34:	89 f2                	mov    %esi,%edx
        sp = (sp - (strlen(argv[argc]) + 2)) & ~3;
        if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
            goto bad;
        ustack[3+argc] = sp;
    ...
    ustack[3+argc] = 0;
80100c36:	c7 84 95 64 ff ff ff 	movl   $0x0,-0x9c(%ebp,%edx,4)
80100c3d:	00 00 00 00 

    ustack[0] = 0xffffffff;  // fake return PC
    ustack[1] = argc;
    ustack[2] = sp - (argc+1)*4;  // argv pointer
80100c41:	8d 04 95 04 00 00 00 	lea    0x4(,%edx,4),%eax
        ustack[3+argc] = sp;
    }
    ustack[3+argc] = 0;
    ...
    ustack[0] = 0xffffffff;  // fake return PC
    ustack[1] = argc;
80100c48:	89 95 5c ff ff ff    	mov    %edx,-0xa4(%ebp)
    ustack[2] = sp - (argc+1)*4;  // argv pointer
80100c4e:	89 da                	mov    %ebx,%edx
80100c50:	29 c2                	sub    %eax,%edx

    sp -= (3+argc+1) * 4;
80100c52:	83 c0 0c             	add    $0xc,%eax
80100c55:	29 c3                	sub    %eax,%ebx
    if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c57:	89 44 24 0c          	mov    %eax,0xc(%esp)
80100c5b:	8b 85 f0 fe ff ff    	mov    -0x110(%ebp),%eax
80100c61:	89 4c 24 08          	mov    %ecx,0x8(%esp)
80100c65:	89 5c 24 04          	mov    %ebx,0x4(%esp)
            goto bad;
        ustack[3+argc] = sp;
    }
    ustack[3+argc] = 0;
...
80100c73:	89 04 24             	mov    %eax,(%esp)
    ...
    ustack[1] = argc;
    ustack[2] = sp - (argc+1)*4;  // argv pointer
80100c76:	89 95 60 ff ff ff    	mov    %edx,-0xa0(%ebp)

    sp -= (3+argc+1) * 4;
    if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
80100c7c:	e8 8f 60 00 00       	call   80106d10 <copyout>
80100c81:	85 c0                	test   %eax,%eax
80100c83:	0f 88 78 ff ff ff    	js     80100c01 <exec+0x261>
        goto bad;

    // Save program name for debugging.
    for(last=s=path; *s; s++)
80100c89:	8b 45 08             	mov    0x8(%ebp),%eax
80100c8c:	0f b6 10             	movzbl (%eax),%edx
80100c8f:	84 d2                	test   %dl,%dl
80100c91:	74 19                	je     80100cac <exec+0x30c>
80100c93:	8b 4d 08             	mov    0x8(%ebp),%ecx
80100c96:	83 c0 01             	add    $0x1,%eax
        if(*s == '/')
            last = s+1;
80100c99:	80 fa 2f             	cmp    $0x2f,%dl
    sp -= (3+argc+1) * 4;
    if(copyout(pgdir, sp, ustack, (3+argc+1)*4) < 0)
        goto bad;
...
80100c9c:	0f b6 10             	movzbl (%eax),%edx
        if(*s == '/')
            last = s+1;
80100c9f:	0f 44 c8             	cmove  %eax,%ecx
...
80100ca7:	75 f0                	jne    80100c99 <exec+0x2f9>
80100ca9:	89 4d 08             	mov    %ecx,0x8(%ebp)
        if(*s == '/')
            last = s+1;
    safestrcpy(curproc->name, last, sizeof(curproc->name));
80100cac:	8b bd f4 fe ff ff    	mov    -0x10c(%ebp),%edi
...
80100cc9:	e8 82 37 00 00       	call   80104450 <safestrcpy>
    ip = 0;
    ...
    // change this for sure
    sz = PGROUNDUP(sz);
80100cce:	8b 85 ec fe ff ff    	mov    -0x114(%ebp),%eax
    safestrcpy(curproc->name, last, sizeof(curproc->name));
    ...
    curproc->pgdir = pgdir;
80100cd4:	8b 95 f0 fe ff ff    	mov    -0x110(%ebp),%edx
            last = s+1;
    safestrcpy(curproc->name, last, sizeof(curproc->name));
    ...
    // is this the heap?
    oldpgdir = curproc->pgdir;
80100cda:	8b 77 04             	mov    0x4(%edi),%esi
    ip = 0;
...
80100ce9:	8b 47 18             	mov    0x18(%edi),%eax
    safestrcpy(curproc->name, last, sizeof(curproc->name));
    ...
    oldpgdir = curproc->pgdir;
    curproc->pgdir = pgdir;
80100cec:	89 57 04             	mov    %edx,0x4(%edi)
    curproc->sz = sz;
    curproc->tf->eip = elf.entry;  // main
80100cef:	8b 95 3c ff ff ff    	mov    -0xc4(%ebp),%edx
80100cf5:	89 50 38             	mov    %edx,0x38(%eax)
    curproc->tf->esp = sp;
80100cf8:	8b 47 18             	mov    0x18(%edi),%eax
80100cfb:	89 58 44             	mov    %ebx,0x44(%eax)
    curproc->pages = 1;
80100cfe:	c7 47 7c 01 00 00 00 	movl   $0x1,0x7c(%edi)
    switchuvm(curproc);
80100d05:	89 3c 24             	mov    %edi,(%esp)
80100d08:	e8 33 59 00 00       	call   80106640 <switchuvm>
    freevm(oldpgdir);
80100d0d:	89 34 24             	mov    %esi,(%esp)
80100d10:	e8 ab 5c 00 00       	call   801069c0 <freevm>
    return 0;
...
80100d24:	e9 0d ff ff ff       	jmp    80100c36 <exec+0x296>
...
80102dc3:	83 ec 08             	sub    $0x8,%esp
  switchkvm();
80102dc6:	e8 55 38 00 00       	call   80106620 <switchkvm>
  seginit();
80102dcb:	e8 10 37 00 00       	call   801064e0 <seginit>
  lapicinit();
...
80102e03:	e8 c8 3c 00 00       	call   80106ad0 <kvmalloc>
...
80102e15:	e8 c6 36 00 00       	call   801064e0 <seginit>
  picinit();       // disable pic
...
80102e2a:	e8 51 2a 00 00       	call   80105880 <uartinit>
80102e2f:	90                   	nop
  pinit();         // process table
...
801036d3:	e8 68 33 00 00       	call   80106a40 <setupkvm>
...
801036f5:	80 
801036f6:	e8 55 30 00 00       	call   80106750 <inituvm>
  p->sz = PGSIZE;
...
801037f9:	e8 a2 30 00 00       	call   801068a0 <allocuvm>
...
80103807:	e8 34 2e 00 00       	call   80106640 <switchuvm>
  return 0;
...
8010382a:	e8 71 31 00 00       	call   801069a0 <deallocuvm>
...
80103865:	8b 40 44             	mov    0x44(%eax),%eax
80103868:	89 44 24 08          	mov    %eax,0x8(%esp)
8010386c:	8b 03                	mov    (%ebx),%eax
8010386e:	89 44 24 04          	mov    %eax,0x4(%esp)
80103872:	8b 43 04             	mov    0x4(%ebx),%eax
80103875:	89 04 24             	mov    %eax,(%esp)
80103878:	e8 a3 32 00 00       	call   80106b20 <copyuvm>
8010387d:	85 c0                	test   %eax,%eax
8010387f:	89 47 04             	mov    %eax,0x4(%edi)
80103882:	0f 84 a5 00 00 00    	je     8010392d <fork+0xed>
    kfree(np->kstack);
    np->kstack = 0;
    np->state = UNUSED;
    return -1;
...
8010388a:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
8010388d:	89 01                	mov    %eax,(%ecx)
  np->parent = curproc;
  *np->tf = *curproc->tf;
8010388f:	8b 79 18             	mov    0x18(%ecx),%edi
80103892:	89 c8                	mov    %ecx,%eax
    np->kstack = 0;
    np->state = UNUSED;
    return -1;
  }
  np->sz = curproc->sz;
  np->parent = curproc;
80103894:	89 59 14             	mov    %ebx,0x14(%ecx)
  *np->tf = *curproc->tf;
80103897:	8b 73 18             	mov    0x18(%ebx),%esi
8010389a:	b9 13 00 00 00       	mov    $0x13,%ecx
8010389f:	f3 a5                	rep movsl %ds:(%esi),%es:(%edi)

  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;

  for(i = 0; i < NOFILE; i++)
801038a1:	31 f6                	xor    %esi,%esi
  np->sz = curproc->sz;
  np->parent = curproc;
  *np->tf = *curproc->tf;
  ...
  // Clear %eax so that fork returns 0 in the child.
  np->tf->eax = 0;
801038a3:	8b 40 18             	mov    0x18(%eax),%eax
801038a6:	c7 40 1c 00 00 00 00 	movl   $0x0,0x1c(%eax)
...
801039a2:	83 eb 80             	sub    $0xffffff80,%ebx
      ...
      c->proc = p;
      switchuvm(p);
801039a5:	e8 96 2c 00 00       	call   80106640 <switchuvm>
      p->state = RUNNING;
...
801039bb:	e8 eb 0a 00 00       	call   801044ab <swtch>
      switchkvm();
801039c0:	e8 5b 2c 00 00       	call   80106620 <switchkvm>
    // Enable interrupts on this processor.
    sti();
...
80103d28:	e8 93 2c 00 00       	call   801069c0 <freevm>
        p->pid = 0;
        p->parent = 0;
        p->name[0] = 0;
        p->killed = 0;
...
80103e74:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e78:	c7 04 24 fb 77 10 80 	movl   $0x801077fb,(%esp)
...
801044ea:	e8 a1 f1 ff ff       	call   80103690 <myproc>
    ...
    if(addr >= KERNBASE - 1)
801044ef:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
...
80105512:	0f 84 58 01 00 00    	je     80105670 <trap+0x170>
        if(myproc()->killed)
            exit();
        return;
    }
...
8010551e:	0f 87 8c 01 00 00    	ja     801056b0 <trap+0x1b0>
80105524:	ff 24 85 7c 76 10 80 	jmp    *-0x7fef8984(,%eax,4)
8010552b:	90                   	nop
...
80105533:	e8 58 e1 ff ff       	call   80103690 <myproc>
80105538:	8b 40 18             	mov    0x18(%eax),%eax
8010553b:	8b 78 44             	mov    0x44(%eax),%edi
            if (add < PGROUNDDOWN(sb) && add > PGROUNDDOWN(sb) - PGSIZE) {
8010553e:	89 f8                	mov    %edi,%eax
80105540:	25 00 f0 ff ff       	and    $0xfffff000,%eax
80105545:	39 f0                	cmp    %esi,%eax
80105547:	76 0d                	jbe    80105556 <trap+0x56>
80105549:	2d 00 10 00 00       	sub    $0x1000,%eax
8010554e:	39 f0                	cmp    %esi,%eax
80105550:	0f 82 2a 02 00 00    	jb     80105780 <trap+0x280>
                // allocate new page 
                myproc()->pages += 1;
                myproc()->tf->esp = allocuvm(pgdir, PGROUNDDOWN(add) - PGSIZE, sb);
            } else {
                cprintf("something went wrong");
80105556:	c7 04 24 c6 75 10 80 	movl   $0x801075c6,(%esp)
...
8010556f:	74 0c                	je     8010557d <trap+0x7d>
80105571:	e8 1a e1 ff ff       	call   80103690 <myproc>
80105576:	8b 50 24             	mov    0x24(%eax),%edx
80105579:	85 d2                	test   %edx,%edx
8010557b:	75 4b                	jne    801055c8 <trap+0xc8>
        exit();

    // Force process to give up CPU on clock tick.
    // If interrupts were on while locks held, would need to check nlock.
    if(myproc() && myproc()->state == RUNNING &&
8010557d:	e8 0e e1 ff ff       	call   80103690 <myproc>
80105582:	85 c0                	test   %eax,%eax
80105584:	74 0c                	je     80105592 <trap+0x92>
80105586:	e8 05 e1 ff ff       	call   80103690 <myproc>
8010558b:	83 78 0c 04          	cmpl   $0x4,0xc(%eax)
8010558f:	90                   	nop
80105590:	74 4e                	je     801055e0 <trap+0xe0>
            tf->trapno == T_IRQ0+IRQ_TIMER)
        yield();

    // Check if the process has been killed since we yielded
    if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
80105592:	e8 f9 e0 ff ff       	call   80103690 <myproc>
80105597:	85 c0                	test   %eax,%eax
80105599:	74 22                	je     801055bd <trap+0xbd>
8010559b:	90                   	nop
8010559c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
801055a0:	e8 eb e0 ff ff       	call   80103690 <myproc>
801055a5:	8b 40 24             	mov    0x24(%eax),%eax
801055a8:	85 c0                	test   %eax,%eax
801055aa:	74 11                	je     801055bd <trap+0xbd>
801055ac:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801055b0:	83 e0 03             	and    $0x3,%eax
801055b3:	66 83 f8 03          	cmp    $0x3,%ax
801055b7:	0f 84 e0 00 00 00    	je     8010569d <trap+0x19d>
        exit();
}
801055bd:	83 c4 3c             	add    $0x3c,%esp
801055c0:	5b                   	pop    %ebx
801055c1:	5e                   	pop    %esi
801055c2:	5f                   	pop    %edi
801055c3:	5d                   	pop    %ebp
...
801055c5:	8d 76 00             	lea    0x0(%esi),%esi
    ...
    // until it gets to the regular system call return.)
    if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
801055c8:	0f b7 43 3c          	movzwl 0x3c(%ebx),%eax
801055cc:	83 e0 03             	and    $0x3,%eax
801055cf:	66 83 f8 03          	cmp    $0x3,%ax
801055d3:	75 a8                	jne    8010557d <trap+0x7d>
        exit();
801055d5:	e8 b6 e4 ff ff       	call   80103a90 <exit>
801055da:	eb a1                	jmp    8010557d <trap+0x7d>
...
801055e4:	75 ac                	jne    80105592 <trap+0x92>
            tf->trapno == T_IRQ0+IRQ_TIMER)
        yield();
801055e6:	e8 c5 e5 ff ff       	call   80103bb0 <yield>
801055eb:	eb a5                	jmp    80105592 <trap+0x92>
801055ed:	8d 76 00             	lea    0x0(%esi),%esi
    ...
    switch(tf->trapno){
        case T_IRQ0 + IRQ_TIMER:
            if(cpuid() == 0){
801055f0:	e8 7b e0 ff ff       	call   80103670 <cpuid>
801055f5:	85 c0                	test   %eax,%eax
801055f7:	0f 84 53 01 00 00    	je     80105750 <trap+0x250>
801055fd:	8d 76 00             	lea    0x0(%esi),%esi
        ...
        case T_IRQ0 + IRQ_SPURIOUS:
            cprintf("cpu%d: spurious interrupt at %x:%x\n",
                    cpuid(), tf->cs, tf->eip);
            lapiceoi();
80105600:	e8 6b d1 ff ff       	call   80102770 <lapiceoi>
            break;
80105605:	e9 5e ff ff ff       	jmp    80105568 <trap+0x68>
8010560a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        ...
        case T_IRQ0 + IRQ_KBD:
            kbdintr();
80105610:	e8 ab cf ff ff       	call   801025c0 <kbdintr>
            lapiceoi();
80105615:	e8 56 d1 ff ff       	call   80102770 <lapiceoi>
            break;
8010561a:	e9 49 ff ff ff       	jmp    80105568 <trap+0x68>
8010561f:	90                   	nop
        case T_IRQ0 + IRQ_COM1:
            uartintr();
80105620:	e8 fb 02 00 00       	call   80105920 <uartintr>
            lapiceoi();
80105625:	e8 46 d1 ff ff       	call   80102770 <lapiceoi>
            break;
8010562a:	e9 39 ff ff ff       	jmp    80105568 <trap+0x68>
8010562f:	90                   	nop
        case T_IRQ0 + 7:
        case T_IRQ0 + IRQ_SPURIOUS:
            cprintf("cpu%d: spurious interrupt at %x:%x\n",
...
80105637:	e8 34 e0 ff ff       	call   80103670 <cpuid>
8010563c:	c7 04 24 e0 75 10 80 	movl   $0x801075e0,(%esp)
...
80105654:	eb a7                	jmp    801055fd <trap+0xfd>
80105656:	66 90                	xchg   %ax,%ax
        ...
        case T_IRQ0 + IRQ_IDE:
            ideintr();
80105658:	e8 13 ca ff ff       	call   80102070 <ideintr>
8010565d:	8d 76 00             	lea    0x0(%esi),%esi
            lapiceoi();
80105660:	e8 0b d1 ff ff       	call   80102770 <lapiceoi>
            break;
80105665:	e9 fe fe ff ff       	jmp    80105568 <trap+0x68>
...
8010567a:	0f 85 c0 00 00 00    	jne    80105740 <trap+0x240>
            exit();
        myproc()->tf = tf;
80105680:	e8 0b e0 ff ff       	call   80103690 <myproc>
80105685:	89 58 18             	mov    %ebx,0x18(%eax)
        syscall();
80105688:	e8 83 ef ff ff       	call   80104610 <syscall>
        if(myproc()->killed)
8010568d:	e8 fe df ff ff       	call   80103690 <myproc>
80105692:	8b 48 24             	mov    0x24(%eax),%ecx
80105695:	85 c9                	test   %ecx,%ecx
80105697:	0f 84 20 ff ff ff    	je     801055bd <trap+0xbd>
        yield();
...
8010569d:	83 c4 3c             	add    $0x3c,%esp
801056a0:	5b                   	pop    %ebx
801056a1:	5e                   	pop    %esi
801056a2:	5f                   	pop    %edi
801056a3:	5d                   	pop    %ebp
        ...
        if(myproc()->killed)
            exit();
801056a4:	e9 e7 e3 ff ff       	jmp    80103a90 <exit>
...
801056b0:	e8 db df ff ff       	call   80103690 <myproc>
801056b5:	85 c0                	test   %eax,%eax
801056b7:	0f 84 02 01 00 00    	je     801057bf <trap+0x2bf>
801056bd:	f6 43 3c 03          	testb  $0x3,0x3c(%ebx)
801056c1:	0f 84 f8 00 00 00    	je     801057bf <trap+0x2bf>
801056c7:	0f 20 d1             	mov    %cr2,%ecx
...
801056ca:	8b 53 38             	mov    0x38(%ebx),%edx
801056cd:	89 4d d8             	mov    %ecx,-0x28(%ebp)
801056d0:	89 55 dc             	mov    %edx,-0x24(%ebp)
801056d3:	e8 98 df ff ff       	call   80103670 <cpuid>
801056d8:	8b 73 30             	mov    0x30(%ebx),%esi
801056db:	89 c7                	mov    %eax,%edi
801056dd:	8b 43 34             	mov    0x34(%ebx),%eax
801056e0:	89 45 e4             	mov    %eax,-0x1c(%ebp)
                    "eip 0x%x addr 0x%x--kill proc\n",
                    myproc()->pid, myproc()->name, tf->trapno,
801056e3:	e8 a8 df ff ff       	call   80103690 <myproc>
801056e8:	89 45 e0             	mov    %eax,-0x20(%ebp)
801056eb:	e8 a0 df ff ff       	call   80103690 <myproc>
                cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
                        tf->trapno, cpuid(), tf->eip, rcr2());
                panic("trap");
            }
            // In user space, assume process misbehaved.
            cprintf("pid %d %s: trap %d err %d on cpu %d "
801056f0:	8b 4d d8             	mov    -0x28(%ebp),%ecx
801056f3:	89 74 24 0c          	mov    %esi,0xc(%esp)
                    "eip 0x%x addr 0x%x--kill proc\n",
                    myproc()->pid, myproc()->name, tf->trapno,
801056f7:	8b 75 e0             	mov    -0x20(%ebp),%esi
                cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
                        tf->trapno, cpuid(), tf->eip, rcr2());
                panic("trap");
            }
            // In user space, assume process misbehaved.
            cprintf("pid %d %s: trap %d err %d on cpu %d "
801056fa:	8b 55 dc             	mov    -0x24(%ebp),%edx
801056fd:	89 7c 24 14          	mov    %edi,0x14(%esp)
80105701:	89 4c 24 1c          	mov    %ecx,0x1c(%esp)
80105705:	8b 4d e4             	mov    -0x1c(%ebp),%ecx
                    "eip 0x%x addr 0x%x--kill proc\n",
                    myproc()->pid, myproc()->name, tf->trapno,
80105708:	83 c6 6c             	add    $0x6c,%esi
                cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
                        tf->trapno, cpuid(), tf->eip, rcr2());
                panic("trap");
            }
            // In user space, assume process misbehaved.
            cprintf("pid %d %s: trap %d err %d on cpu %d "
8010570b:	89 54 24 18          	mov    %edx,0x18(%esp)
                    "eip 0x%x addr 0x%x--kill proc\n",
                    myproc()->pid, myproc()->name, tf->trapno,
8010570f:	89 74 24 08          	mov    %esi,0x8(%esp)
                cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
                        tf->trapno, cpuid(), tf->eip, rcr2());
                panic("trap");
            }
            // In user space, assume process misbehaved.
            cprintf("pid %d %s: trap %d err %d on cpu %d "
80105713:	89 4c 24 10          	mov    %ecx,0x10(%esp)
80105717:	8b 40 10             	mov    0x10(%eax),%eax
8010571a:	c7 04 24 38 76 10 80 	movl   $0x80107638,(%esp)
...
80105725:	e8 26 af ff ff       	call   80100650 <cprintf>
            ...
            myproc()->killed = 1;
8010572a:	e8 61 df ff ff       	call   80103690 <myproc>
8010572f:	c7 40 24 01 00 00 00 	movl   $0x1,0x24(%eax)
80105736:	e9 2d fe ff ff       	jmp    80105568 <trap+0x68>
8010573b:	90                   	nop
...
trap(struct trapframe *tf)
{
    if(tf->trapno == T_SYSCALL){
        if(myproc()->killed)
            exit();
80105740:	e8 4b e3 ff ff       	call   80103a90 <exit>
80105745:	e9 36 ff ff ff       	jmp    80105680 <trap+0x180>
...
8010577b:	e9 7d fe ff ff       	jmp    801055fd <trap+0xfd>
            pde_t * pgdir = 0;
            uint add = rcr2();
            uint sb = myproc()->tf->esp;
            if (add < PGROUNDDOWN(sb) && add > PGROUNDDOWN(sb) - PGSIZE) {
...
8010578b:	81 ee 00 10 00 00    	sub    $0x1000,%esi
            pde_t * pgdir = 0;
            uint add = rcr2();
            uint sb = myproc()->tf->esp;
            if (add < PGROUNDDOWN(sb) && add > PGROUNDDOWN(sb) - PGSIZE) {
                // allocate new page 
                myproc()->pages += 1;
80105791:	83 40 7c 01          	addl   $0x1,0x7c(%eax)
                myproc()->tf->esp = allocuvm(pgdir, PGROUNDDOWN(add) - PGSIZE, sb);
80105795:	e8 f6 de ff ff       	call   80103690 <myproc>
8010579a:	8b 50 18             	mov    0x18(%eax),%edx
8010579d:	89 7c 24 08          	mov    %edi,0x8(%esp)
801057a1:	89 74 24 04          	mov    %esi,0x4(%esp)
801057a5:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
801057ac:	89 55 e4             	mov    %edx,-0x1c(%ebp)
801057af:	e8 ec 10 00 00       	call   801068a0 <allocuvm>
801057b4:	8b 55 e4             	mov    -0x1c(%ebp),%edx
801057b7:	89 42 44             	mov    %eax,0x44(%edx)
801057ba:	e9 a9 fd ff ff       	jmp    80105568 <trap+0x68>
801057bf:	0f 20 d7             	mov    %cr2,%edi
        ...
        default:
            if(myproc() == 0 || (tf->cs&3) == 0){
                ...
                cprintf("unexpected trap %d from cpu %d eip %x (cr2=0x%x)\n",
801057c2:	8b 73 38             	mov    0x38(%ebx),%esi
801057c5:	e8 a6 de ff ff       	call   80103670 <cpuid>
801057ca:	89 7c 24 10          	mov    %edi,0x10(%esp)
801057ce:	89 74 24 0c          	mov    %esi,0xc(%esp)
801057d2:	89 44 24 08          	mov    %eax,0x8(%esp)
801057d6:	8b 43 30             	mov    0x30(%ebx),%eax
801057d9:	c7 04 24 04 76 10 80 	movl   $0x80107604,(%esp)
801057e0:	89 44 24 04          	mov    %eax,0x4(%esp)
801057e4:	e8 67 ae ff ff       	call   80100650 <cprintf>
                        tf->trapno, cpuid(), tf->eip, rcr2());
                panic("trap");
801057e9:	c7 04 24 db 75 10 80 	movl   $0x801075db,(%esp)
801057f0:	e8 6b ab ff ff       	call   80100360 <panic>
...
80105857:	e8 34 cf ff ff       	call   80102790 <microdelay>
{
  int i;
...
801058e7:	00 
  ...
  for(p="xv6...\n"; *p; p++)
801058e8:	bb 44 77 10 80       	mov    $0x80107744,%ebx
...
801058f4:	e8 a7 c9 ff ff       	call   801022a0 <ioapicenable>
...
80105936:	6a 00                	push   $0x0
  jmp alltraps
80105938:	e9 d0 fa ff ff       	jmp    8010540d <alltraps>
...
8010593f:	6a 01                	push   $0x1
  jmp alltraps
80105941:	e9 c7 fa ff ff       	jmp    8010540d <alltraps>
...
80105948:	6a 02                	push   $0x2
  jmp alltraps
8010594a:	e9 be fa ff ff       	jmp    8010540d <alltraps>
...
80105951:	6a 03                	push   $0x3
  jmp alltraps
80105953:	e9 b5 fa ff ff       	jmp    8010540d <alltraps>
...
8010595a:	6a 04                	push   $0x4
  jmp alltraps
8010595c:	e9 ac fa ff ff       	jmp    8010540d <alltraps>
...
80105993:	6a 0b                	push   $0xb
  jmp alltraps
80105995:	e9 73 fa ff ff       	jmp    8010540d <alltraps>
...
801059a8:	6a 0e                	push   $0xe
  jmp alltraps
801059aa:	e9 5e fa ff ff       	jmp    8010540d <alltraps>
...
801063f4:	e8 97 c0 ff ff       	call   80102490 <kalloc>
...
80106412:	e8 59 de ff ff       	call   80104270 <memset>
        // The permissions here are overly generous, but they can
        // be further restricted by the permissions in the page table
        // entries, if necessary.
        *pde = V2P(pgtab) | PTE_P | PTE_W | PTE_U;
...
80106483:	e8 58 be ff ff       	call   801022e0 <kfree>
            *pte = 0;
...
801064e3:	83 ec 18             	sub    $0x18,%esp
    ...
    c = &cpus[cpuid()];
801064e6:	e8 85 d1 ff ff       	call   80103670 <cpuid>
...
80106611:	c3                   	ret    
    ...
    for(;;){
        ...
        if(*pte & PTE_P)
            panic("remap");
80106612:	c7 04 24 4c 77 10 80 	movl   $0x8010774c,(%esp)
...
80106664:	0f 84 c3 00 00 00    	je     8010672d <switchuvm+0xed>
    ...
    pushcli();
8010666a:	e8 81 da ff ff       	call   801040f0 <pushcli>
    mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
8010666f:	e8 7c cf ff ff       	call   801035f0 <mycpu>
80106674:	89 c3                	mov    %eax,%ebx
80106676:	e8 75 cf ff ff       	call   801035f0 <mycpu>
8010667b:	89 c7                	mov    %eax,%edi
8010667d:	e8 6e cf ff ff       	call   801035f0 <mycpu>
80106682:	83 c7 08             	add    $0x8,%edi
80106685:	89 45 e4             	mov    %eax,-0x1c(%ebp)
80106688:	e8 63 cf ff ff       	call   801035f0 <mycpu>
...
801066c9:	bb ff ff ff ff       	mov    $0xffffffff,%ebx
    ...
    mycpu()->gdt[SEG_TSS] = SEG16(STS_T32A, &mycpu()->ts,
            sizeof(mycpu()->ts)-1, 0);
    mycpu()->gdt[SEG_TSS].s = 0;
801066ce:	e8 1d cf ff ff       	call   801035f0 <mycpu>
801066d3:	80 a0 9d 00 00 00 ef 	andb   $0xef,0x9d(%eax)
    mycpu()->ts.ss0 = SEG_KDATA << 3;
801066da:	e8 11 cf ff ff       	call   801035f0 <mycpu>
801066df:	b9 10 00 00 00       	mov    $0x10,%ecx
801066e4:	66 89 48 10          	mov    %cx,0x10(%eax)
    mycpu()->ts.esp0 = (uint)p->kstack + KSTACKSIZE;
801066e8:	e8 03 cf ff ff       	call   801035f0 <mycpu>
...
801066f6:	89 48 0c             	mov    %ecx,0xc(%eax)
    ...
    // forbids I/O instructions (e.g., inb and outb) from user space
    mycpu()->ts.iomb = (ushort) 0xFFFF;
801066f9:	e8 f2 ce ff ff       	call   801035f0 <mycpu>
...
8010671b:	5d                   	pop    %ebp
    ...
    lcr3(V2P(p->pgdir));  // switch to process's address space
    popcli();
8010671c:	e9 8f da ff ff       	jmp    801041b0 <popcli>
// Switch TSS and h/w page table to correspond to process p.
    void
switchuvm(struct proc *p)
{
    if(p == 0)
        panic("switchuvm: no process");
80106721:	c7 04 24 52 77 10 80 	movl   $0x80107752,(%esp)
80106728:	e8 33 9c ff ff       	call   80100360 <panic>
    if(p->kstack == 0)
        panic("switchuvm: no kstack");
    if(p->pgdir == 0)
        panic("switchuvm: no pgdir");
8010672d:	c7 04 24 7d 77 10 80 	movl   $0x8010777d,(%esp)
...
switchuvm(struct proc *p)
{
    ...
    if(p->kstack == 0)
        panic("switchuvm: no kstack");
80106739:	c7 04 24 68 77 10 80 	movl   $0x80107768,(%esp)
...
8010676a:	89 55 e4             	mov    %edx,-0x1c(%ebp)
    ...
    mem = kalloc();
8010676d:	e8 1e bd ff ff       	call   80102490 <kalloc>
    memset(mem, 0, PGSIZE);
...
80106785:	89 c3                	mov    %eax,%ebx
    memset(mem, 0, PGSIZE);
80106787:	e8 e4 da ff ff       	call   80104270 <memset>
...
801067c8:	5d                   	pop    %ebp
    ...
    mappages(pgdir, 0, PGSIZE, V2P(mem), PTE_W|PTE_U);
    memmove(mem, init, sz);
801067c9:	e9 42 db ff ff       	jmp    80104310 <memmove>
inituvm(pde_t *pgdir, char *init, uint sz)
{
    char *mem;
    ...
    if(sz >= PGSIZE)
        panic("inituvm: more than a page");
801067ce:	c7 04 24 91 77 10 80 	movl   $0x80107791,(%esp)
...
8010685d:	e8 ee b0 ff ff       	call   80101950 <readi>
...
80106881:	c3                   	ret    
    ...
    for(i = 0; i < sz; i += PGSIZE){
        if((pte = walkpgdir(pgdir, addr+i, 0)) == 0)
            panic("loaduvm: address should exist");
80106882:	c7 04 24 ab 77 10 80 	movl   $0x801077ab,(%esp)
80106889:	e8 d2 9a ff ff       	call   80100360 <panic>
{
    ...
    if((uint) addr % PGSIZE != 0)
        panic("loaduvm: addr must be page aligned");
8010688e:	c7 04 24 4c 78 10 80 	movl   $0x8010784c,(%esp)
...
801068eb:	e8 80 d9 ff ff       	call   80104270 <memset>
...
80106925:	76 29                	jbe    80106950 <allocuvm+0xb0>
        mem = kalloc();
80106927:	e8 64 bb ff ff       	call   80102490 <kalloc>
        if(mem == 0){
...
80106930:	75 a6                	jne    801068d8 <allocuvm+0x38>
            cprintf("allocuvm out of memory\n");
80106932:	c7 04 24 c9 77 10 80 	movl   $0x801077c9,(%esp)
...
8010695a:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
        ...
        if(mappages(pgdir, (char*)a, PGSIZE, V2P(mem), PTE_W|PTE_U) < 0){
            cprintf("allocuvm out of memory (2)\n");
80106960:	c7 04 24 e1 77 10 80 	movl   $0x801077e1,(%esp)
...
80106981:	e8 5a b9 ff ff       	call   801022e0 <kfree>
            return 0;
...
80106a0d:	e8 ce b8 ff ff       	call   801022e0 <kfree>
    uint i;
...
80106a22:	5d                   	pop    %ebp
    ...
    kfree((char*)pgdir);
80106a23:	e9 b8 b8 ff ff       	jmp    801022e0 <kfree>
freevm(pde_t *pgdir)
{
    uint i;
    ...
    if(pgdir == 0)
        panic("freevm: no pgdir");
80106a28:	c7 04 24 fd 77 10 80 	movl   $0x801077fd,(%esp)
...
80106a48:	e8 43 ba ff ff       	call   80102490 <kalloc>
...
80106a6b:	e8 00 d8 ff ff       	call   80104270 <memset>
    if (P2V(PHYSTOP) > (void*)DEVSPACE)
        panic("PHYSTOP too high");
    for(k = kmap; k < &kmap[NELEM(kmap)]; k++)
...
80106b0b:	c3                   	ret    
{
    ...
    if(pte == 0)
        panic("clearpteu");
80106b0c:	c7 04 24 0e 78 10 80 	movl   $0x8010780e,(%esp)
...
80106b5d:	e8 ae d7 ff ff       	call   80104310 <memmove>
...
80106bc6:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
        flags = PTE_FLAGS(*pte);
        if((mem = kalloc()) == 0)
80106bcc:	e8 bf b8 ff ff       	call   80102490 <kalloc>
...
80106bf9:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
...
80106c54:	81 fb fe ff ff 7f    	cmp    $0x7ffffffe,%ebx
...
80106ca8:	e9 3b ff ff ff       	jmp    80106be8 <copyuvm+0xc8>
    for(i = 0; i < sz; i += PGSIZE){
        ...
        if(!(*pte & PTE_P))
            panic("copyuvm: page not present");
80106cad:	c7 04 24 32 78 10 80 	movl   $0x80107832,(%esp)
80106cb4:	e8 a7 96 ff ff       	call   80100360 <panic>
    ...
    for(i = 0; i < sz; i += PGSIZE){
        if((pte = walkpgdir(pgdir, (void *) i, 0)) == 0)
            panic("copyuvm: pte should exist");
80106cb9:	c7 04 24 18 78 10 80 	movl   $0x80107818,(%esp)
...
80106da6:	c7 44 24 04 70 78 10 	movl   $0x80107870,0x4(%esp)
80106dad:	80 
